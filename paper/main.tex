...
This suggests that under standard JPEG augmentation, patch-level transitions already capture compression-robust features that overlap with what DCPT provides, making the two approaches largely redundant rather than complementary.
