...
Experiments on GenImage with three random seeds show that \ours{} provides consistent improvement under JPEG compression in the multi-generator training setting ($+4.6\%$ accuracy at $Q{=}30$ over CLIP+LoRA, $89.4{\pm}2.6\%$ \vs{} $84.8{\pm}3.9\%$), with notably lower variance across seeds.
...
\ours{} achieves $89.4{\pm}2.6\%$ at $Q{=}30$, outperforming CLIP+LoRA by $+4.6\%$ ($84.8{\pm}3.9\%$) and CLS-LTD by $+5.6\%$ ($83.8{\pm}4.1\%$), with lower variance.
